  ...
  React.useEffect(() => {
    ...
    k.scene("game", ({ levelId, coins } = { levelId: 0, coins: 0 }) => {
      ...
      const mapkeys = {
        ...
        u: () => [k.sprite("pipe_up"), k.area(), k.solid(), "pipe_up_top"],
      ...
      mario.onCollide("pipe_up_top", (pipe_up_top) => {
        k.onKeyDown(["down", "s"], () => {
          k.go("level2");
        });
      });
    ...
    k.scene("level2", ({ levelId, coins } = { levelId: 0, coins: 0 }) => {
      k.gravity(3200);
      // k.play("gameSound");
      const map = [
        "                                                    ",
      ...
      // mario.onCollide(pip_up_top2, () => {
      //   mario.pos.x = pipe_up_top.pos.x;
      // });
      ...
      mario.onCollide(pip_up_top2, (pip_up_top2) => {
        k.onKeyDown(["down", "s"], () => {
          k.go("level2");
        });
      });
